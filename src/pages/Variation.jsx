  ...
  return (
    <div className="w-full">
      <Tabs className="w-full" activeKey={activeTab} onChange={handleTabChange}>
        <TabPane tab="Create variation information" key="create-infor">
          <RenderForm mode={"create"} formFormat={FORMS.variationInformation} />
        </TabPane>
        <TabPane tab="Table variation list" key="table-infor">
          {/* <RenderTable  tableFormat={TABLES.test} /> */}
          <RenderTable tableFormat={TABLES.variationInformation} />
        </TabPane>
      </Tabs>
    </div>
  );
